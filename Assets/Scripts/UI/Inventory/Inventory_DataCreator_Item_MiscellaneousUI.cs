...
public class Inventory_DataCreator_Item_MiscellaneousUI : Inventory_DataCreator_ItemUI {
    ...
    //Functions
		...
		protected override void CreateEntity(InventoryData inventoryData) {
			...
			List<ItemData> m_iD = inventoryData.GetMiscellaneousList().FindAll(c => c.GetCount() > 0 || c.GetUnlocked());
